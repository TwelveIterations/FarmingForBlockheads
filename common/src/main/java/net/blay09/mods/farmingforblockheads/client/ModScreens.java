...
import net.blay09.mods.farmingforblockheads.client.gui.screen.FishingBarrelScreen;
import net.blay09.mods.farmingforblockheads.client.gui.screen.MarketScreen;
import net.blay09.mods.farmingforblockheads.client.gui.screen.ShippingBinScreen;
...
public class ModScreens {
    public static void initialize(BalmMenuScreenRegistrar screens) {
        ...
        screens.register(ModMenus.shippingBin, ShippingBinScreen::new);
        screens.register(ModMenus.fishingBarrel, FishingBarrelScreen::new);
    }
}
