...
For information on how to customize the market trades, see the [README on GitHub](https://github.com/TwelveIterations/FarmingForBlockheads/blob/1.19.x/README.md#custom-market-entries).
